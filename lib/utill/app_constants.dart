...
class AppConstants {
  static const String APP_NAME = 'YallaPick';
  static const String BASE_URL = 'https://yallapick.com';
  ...
  static const String CHECK_JD_MINIMUM_ORDER_URI =
      '/api/v1/cart/check-jd-minimum-order';
  static const String GET_JD_MINIMUM_ORDER_AMOUNT_URI =
      '/api/v1/cart/jd-minimum-order-amount';
  ...
  static const String GEOCODE_URI = '/api/v1/map api/geocode-api';
  ...
  //country
  static const String COUNTRY_URI = '/api/v1/products/country';
  static const String STATE_URI = '/api/v1/products/state/';
  static const String CITIES_URI = '/api/v1/products/cities/';
  static const String ALL_CITIES_URI = '/api/v1/products/get_cities_all';
  static const String CONTACT_US_URI = '/api/v1/contact-us';
}
