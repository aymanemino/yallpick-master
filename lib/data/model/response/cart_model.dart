...
class CartModel {
  ...
  CartModel(
    ...
    this._discountedPrice = discountedPrice ?? 0.0;
    this._quantity = quantity ?? 0;
    this._maxQuantity = maxQuantity ?? 0;
