        ...
        child: Column(
          ...
          children: [
            ...
            Text(isNoInternet ? getTranslated('OPPS', context) : getTranslated('sorry', context), style: titilliumBold.copyWith(
              fontSize: 30,
              color: isNoInternet ? Theme.of(context).textTheme.bodyText1?.color ?? Colors.black : ColorResources.getColombiaBlue(context),
            )),
            SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
            Text(
              isNoInternet ? getTranslated('no_internet_connection', context) : getTranslated('no_data_found', context),
