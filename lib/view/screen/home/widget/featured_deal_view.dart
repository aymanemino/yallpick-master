                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      width: isHomePage ? 300.0 : 200.0,
                      height:
                          180.0, // Adjusted the height to accommodate new labels
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    fit: BoxFit
                                        .contain, // Ensuring the image fits properly
                                    image:
                                        '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}/${featuredDealProvider.featuredDealProductList[index].thumbnail}',
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(
                                              width:
                                                  25), // Space between price and rating
                                          Text(
                                            featuredDealProvider
                                                        .featuredDealProductList[
                                                            index]
