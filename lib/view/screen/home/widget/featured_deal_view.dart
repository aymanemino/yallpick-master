                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}/${featuredDealProvider.featuredDealProductList[index].thumbnail}',
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Text(
                                      PriceConverter.convertPrice(
                                          ...
                                          discountType: featuredDealProvider.featuredDealProductList[index].discountType,
                                          discount: featuredDealProvider.featuredDealProductList[index].discount.toDouble()
                                      ),
                                      style: robotoBold.copyWith(color: ColorResources.getPrimary(context)),
                                    ),
                                    SizedBox(width: 25), // Space between price and rating
                                    Text(
                                      featuredDealProvider.featuredDealProductList[index].rating != null
                                          ? double.parse(featuredDealProvider.featuredDealProductList[index].rating[0].average).toStringAsFixed(1)
                                          : '0.0',
                                ...
                                if (featuredDealProvider.featuredDealProductList[index].discount > 0)
                                  Row(
                                    children: [
                                      Container(
