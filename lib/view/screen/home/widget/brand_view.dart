                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            padding: EdgeInsets
                                .zero, // Remove padding to ensure maximum available space
                            margin: EdgeInsets
                                .zero, // Remove margin so the image takes full available space
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              color: Theme.of(context)
                                  .highlightColor, // White background
                              boxShadow: [
                                BoxShadow(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(
                                  10), // Keep rounded corners for the container
                              child: Image.network(
                                ...
                                fit: BoxFit
                                    .contain, // Ensures image fits fully inside without distortion or pixelation
                                width: double
                                    .infinity, // Ensure the image takes the full width
                                height: double
                                    .infinity, // Ensure the image takes the full height
