                                        ...
                                        ListTile(
                                          leading: ClipOval(
                                            child: Container(
                                              color: Theme.of(context)
                                                  .highlightColor,
                                              child: chat.uniqueShopList[index]
                                                              .sellerInfo !=
                                                          null &&
                                                      chat
                                                              .uniqueShopList[
                                                  ...
                                                  ? FadeInImage.assetNetwork(
                                                      ...
                                                      width: 50,
                                                      image:
                                                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls.sellerImageUrl}/${chat.uniqueShopList[index].sellerInfo.image}',
                                          ...
                                          title: Text(
                                            chat.uniqueShopList[index]
                                                        .sellerInfo !=
                                                    null
                                                ? '${chat.uniqueShopList[index].sellerInfo.fName ?? ''} ${chat.uniqueShopList[index].sellerInfo.lName ?? ''}'
                                                        .trim()
                                                        .isEmpty
                                                    ? 'Unknown Seller'
                                                    : '${chat.uniqueShopList[index].sellerInfo.fName ?? ''} ${chat.uniqueShopList[index].sellerInfo.lName ?? ''}'
