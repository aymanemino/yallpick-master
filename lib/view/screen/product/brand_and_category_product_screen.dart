              ...
              children: [
                ...
                SearchWidget(
                  ...
                  onTextChanged: (String newText) =>
                      Provider.of<ProductProvider>(context, listen: false)
                          .brandFilterData(newText),
                  onClearPressed: () {
                    productProvider.initBrandOrCategoryProductList(
                        isBrand, id, context);
                  },
                ),
                !isBrand && subcategory.length != 0
                    ? SizedBox(
                        height:
                            100, // Adjust height to fit one row of categories
                        child: Padding(
                          ...
                          child: GridView.builder(
                            ...
                            gridDelegate:
                              ...
                              mainAxisExtent:
                                  90, // Width of each item (adjusted)
                              crossAxisSpacing: 8, // Space between items
                              mainAxisSpacing:
                                  0, // Minimized space between rows
                            ),
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  margin: EdgeInsets.symmetric(
                                      horizontal:
                                          2), // Reduced margin between items
                                  child: Stack(
