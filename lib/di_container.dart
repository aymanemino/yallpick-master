...
import 'package:flutter_sixvalley_ecommerce/provider/speechtotext_provider.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ContactUsRepo(dioClient: sl()));
  ...
  sl.registerFactory(() => ContactUsProvider(contactUsRepo: sl()));
  sl.registerFactory(() => SpeechToTextProvider());
